class dzProductWrapperCode extends dzEditableComponent{
  constructor() {
    super();
    this.itemManager = new DataPackage('product');
  }
  static getName() {
    return 'dz-product-wrapper';
  }
...
customElements.define(dzProductWrapperCode.getName(), dzProductWrapperCode);
